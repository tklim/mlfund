...
# Balanced second 50/50 run group: 3 three-year and 2 five-year funds.

set -Eeuo pipefail

repo_root="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
backtest_script="$repo_root/scripts/backtest-ema-ga10-index.py"
log_file="$repo_root/run50b.log"
...
files=(
    ...
    MAUS_RMH_USEquityRMH_nav_3Y.csv
    MAKGCF_GreaterChina_nav_5Y.csv
    MAPAC_AsiaPacificexJapan_nav_5Y.csv
)
lookbacks=(1 2 3)
offsets=(3 6 9 12)
