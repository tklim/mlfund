...
call :RunOne 6 "SPGA_ShariahPRSGoldenAsiaClassC_nav_3Y.csv
...
call :RunOne 6 "SPGA_ShariahPRSGoldenAsiaClassC_nav_5Y.csv
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '.\run.ps1' -Population 8 -Generations 4 -GaSearchPreset grid -ExtraArgs @('--data-file', '.\data\%FILE%')"
