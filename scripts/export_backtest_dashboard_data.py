...
def fund_signal_link() -> str:
    return '<a class="external-dashboard-link" href="https://fund-signal-dashboard.ltkiat.workers.dev/" target="_blank" rel="noopener noreferrer">Fund Signal Dashboard ↗</a>'
...
<header class="topbar">{brand('index.html')}<div class="top-actions"><a class="external-dashboard-link" href="https://fund-signal-dashboard.ltkiat.workers.dev/" target="_blank" rel="noopener noreferrer">Fund Signal Dashboard ↗</a><span class="fresh"><i></i>Local snapshot · {date_text(snapshot['latestObservation'])}</span>{theme_button()}</div></header>
...
<header class="topbar">{brand('../index.html')}<div class="top-actions">{fund_signal_link()}<span class="fresh"><i></i>History refreshed {written}</span>{theme_button()}</div></header>
...
def render_detail(fund: dict[str, object]) -> str:
    ...
    return page_head(f"{fund['code']} · Backtest Intelligence", "../../", f"Backtest evidence and diagnostics for {fund['name']}.") + f"""<body><div class="site-shell detail-page"><header class="topbar">{brand('../../index.html')}<div class="top-actions">{fund_signal_link()}{theme_button()}</div></header><main class="detail-shell"><a class="back-link" href="../../index.html">← Master dashboard</a>
